...
public class PluginInfoTest {
    ...
    public void getLastRelease() {
        assertEquals("1.0.0", pi1.getLastRelease("2.0.1").version);
        assertEquals("1.0.0", pi1.getLastRelease("2.5.0").version);
        assertEquals("1.1.0", pi1.getLastRelease("2.1.8").version);
        assertEquals("1.2.0", pi1.getLastRelease("3.0.0").version);
        assertEquals("1.2.0", pi1.getLastRelease("0.0.0").version);
        assertEquals(null, pi1.getLastRelease("4.0.0"));
    }

    @Test
    public void hasUpdate() {
        assertTrue(pi1.hasUpdate("3.0.0", "1.1.0"));
        assertFalse(pi1.hasUpdate("2.3.0", "1.1.0"));
        ...
        assertFalse(pi1.hasUpdate("5.0.0", "1.0.0"));
    }
